...
function LoginForm() {
  ...
  const callbackUrl = searchParams.get("callbackUrl") || "/role-select";
        ...
        <Card className="border-border/50 shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-base">
              Sign in to manage your shop or view your receipts
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="relative py-2">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card px-2 text-muted-foreground">Secure & Eco-friendly</span>
              </div>
            </div>

            <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
              <Leaf size={16} className="text-primary" />
              <span>Every digital receipt saves a tree</span>
            </div>
          </CardContent>
        </Card>
      </motion.div>
